...
import TournamentResultGenerator from './TournamentResultGenerator';
import { TournamentFixtureFormats } from '../../../constants';

const TournamentLiveResults = ({ fixtures, EventFormat }) => {
  if (!fixtures || fixtures.length === 0) {
    return (
      <div>
        <p className='text-center py-6 font-general font-medium text-383838 text-sm md:text-base'>
          No Results are available for this category
        </p>
      </div>
    );
  }
...
export default TournamentLiveResults;
