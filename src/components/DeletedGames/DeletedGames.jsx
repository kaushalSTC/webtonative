...
import { useGetDeletedGames } from '../../hooks/GameHooks';
import GameCard from '../GameCard/GameCard';
import Loader from '../Loader/Loader';

const DeletedGames = () => {
    const player = useSelector((state) => state.player);
    const { data: gameDeleted, isLoading } = useGetDeletedGames(player.id);
    ...
    if (gameDeleted && gameDeleted.length === 0) return null;
