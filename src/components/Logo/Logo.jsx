...
const Logo = ({className = '', light = false}) => {
  const fill = light ? "#ffffff" : "#244cb4";

  return ( 
    <NavLink to="/" className={`${className || ""} block`}>
      <span className="sr-only">Picklebay</span>
      <svg xmlns="http://www.w3.org/2000/svg" width="137.782" height="28.112" viewBox="0 0 137.782 28.112" aria-label="Picklebay Logo" className={className}>
        <g id="Group_11533" data-name="Group 11533" transform="translate(0 -0.001)">
          <rect id="Rectangle_3283" data-name="Rectangle 3283" width="3.419" height="16.257" transform="translate(22.326 6.084)" fill={`${fill}`}/>
          <g id="Group_9857" data-name="Group 9857" transform="translate(0 0.001)">
            <g id="Group_9859" data-name="Group 9859">
              <path id="Path_5355" data-name="Path 5355" d="M213.3,26.9h-2.992a.214.214,0,0,1-.214-.214V5.96a.214.214,0,0,1,.214-.214H213.3a.214.214,0,0,1,.214.214V26.687a.214.214,0,0,1-.214.214" transform="translate(-166.724 -4.56)" fill={`${fill}`}/>
              <rect id="Rectangle_3284" data-name="Rectangle 3284" width="3.419" height="21.154" transform="translate(60.274 1.186)" fill={`${fill}`}/>
              <path id="Path_5356" data-name="Path 5356" d="M144.279,44.716a8.452,8.452,0,1,1,.191-16.9,8.365,8.365,0,0,1,4.774,1.609.215.215,0,0,1,.042.3l-1.691,2.2a.214.214,0,0,1-.3.042,5.2,5.2,0,0,0-3.107-.956,5.246,5.246,0,0,0,.085,10.492,5.191,5.191,0,0,0,3.035-.966.214.214,0,0,1,.294.041l1.7,2.2a.215.215,0,0,1-.041.3,8.37,8.37,0,0,1-4.987,1.627" transform="translate(-107.789 -22.071)" fill={`${fill}`}/>
              <path id="Path_5357" data-name="Path 5357" d="M511.631,28.5v1.346a8.475,8.475,0,1,0,0,13.259v1.245a.214.214,0,0,0,.214.214h2.778a.214.214,0,0,0,.214-.214V28.5a.214.214,0,0,0-.214-.214h-2.778a.214.214,0,0,0-.214.214m-5.7,13.226a5.268,5.268,0,1,1,5.68-5.679,5.289,5.289,0,0,1-5.68,5.679" transform="translate(-395.112 -22.221)" fill={`${fill}`}/>
